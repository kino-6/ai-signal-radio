...
- [ ] `relevance_score` / `read_in_daily` / `wiki_only` を final selection に反映する
- [ ] `config/editorial/ai-process-improvement.yml` を topic sample として追加する
- [ ] LLM が壊れた JSON を返したときは deterministic selection に fallback する
